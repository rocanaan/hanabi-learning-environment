...
def launch_experiment():
  ...
  return_collection = run_experiment.run_experiment(agent, environment, start_iteration,
                                obs_stacker,
                                experiment_logger, experiment_checkpointer,
                                checkpoint_save_dir,
                                num_iterations=latest_checkpoint_version+1+int(FLAGS.num_of_iterations),
...
def main(unused_argv):
  ...
  """
  return_collection = launch_experiment()
